...
def forward(model, classifier_layer_1, classifier_layer_2, classifier_layer_3, data, labels_source, labels_target, criterion, MMD_loss_calculator, GAMMA):
        ...
        for i in range(len(labels_source)):
            ...
            #Distribution plot sorting samples to classes and domains
            if label_source == 0:
        ...
        #Normalize Source Domain Accuracy
        ...
        #Normalize Target Domain Accuracy
...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        #plot distribution plot data collector
            ...
            for i in range(len(dataloaders[phase]["source"])):
                ...
                if phase == "val":
                    ...
                    with torch.no_grad():
                        ...
                        # collect learning curve plot data
                        loss_collected += loss
                        ...
                        # collect distirbution plot data
