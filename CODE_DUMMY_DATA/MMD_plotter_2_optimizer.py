...
def plot_curves():
    ...
    plt.plot(df["acc_total_source_mmd"], 'bo-', label = 'MMD-Loss', linewidth=1,markersize=0.1)
    plt.plot(df["acc_total_source_ce"], 'bo-', label = 'CE-Loss', linewidth=1,markersize=0.1)
    ...
    plt.plot(df["acc_total_target_mmd"], 'co-', label = 'MMD-Loss', linewidth=1,markersize=0.1)
    plt.plot(df["acc_total_target_ce"], 'co-', label = 'CE-Loss', linewidth=1,markersize=0.1)
    ...
    plt.plot(df["source_ce_loss_mmd"], 'bo-', label = 'MMD-Loss', linewidth=1,markersize=0.1)
    plt.plot(df["source_ce_loss_ce"], 'bo-', label = 'CE-Loss', linewidth=1,markersize=0.1)
    ...
    plt.plot(df["target_ce_loss_mmd"], 'co-', label = 'MMD-Loss', linewidth=1,markersize=0.1)
    plt.plot(df["target_ce_loss_ce"], 'co-', label = 'CE-Loss', linewidth=1,markersize=0.1)
    ...
    plt.plot(df["mmd_loss_mmd"], 'bo-', label = 'MMD-Loss', linewidth=1,markersize=0.1)
    plt.plot(df["mmd_loss_ce"], 'bo-', label = 'CE-Loss', linewidth=1,markersize=0.1)
